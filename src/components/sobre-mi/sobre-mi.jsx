...
function SobreMi() {
    ...
    return (
        ...
        <section id="sobreMi" className="linea-horizontal   ">
            <div className="linea-vertical py-20 mx-auto max-w-5xl ">
                {/* Padding interno de la seccion */}
                    {/* div: Controla el div img y el div texto */}
                    {/*Margen entre las dos secciones */}
                    <div className="linea-horizontal linea-vertical  flex grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 my-5">
                        ...
                        <div className="linea-horizontal linea-vertical w-full sm:w-full md:w-2/2  my-auto ">
                    ...
                    <div className="linea-horizontal seccion-tarjetas mx-auto   w-8/10  grid gap-5 grid-cols-1 md:grid-cols-2 lg:grid-cols-4  text-center  
                        ">
